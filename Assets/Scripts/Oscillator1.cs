...
public class Oscillator1 : MonoBehaviour {
	Vector3 movementVector = new Vector3 (-11.5f,-12f); //Vetor de deslocamento, usar [SerializeField] Vector3 movementVector; para experimentar outros vetores
	
	float period = 6f; //Periodo de 6 segundos
	Vector3 startingPos;
	...
	void Update () {
		...
		float cycles = Time.time / period; //Cresce continuamente, a partir de zero, adicionando 1 a cada 6 segundos.
